...
I am a PhD student in Biostatistics at the University of Massachusetts Amherst (*anticipated completion date: summer 2022). I research causal inference, machine learning, and cluster-randomized trials (CRTs) with [Laura Balzer](https://www.balzerlab.com/) and [Ken Kleinman](https://www.kleinman.science/). Before entering the PhD program, I was a high school math teacher for 8 years, among other things. Here is [my full CV](https://joshua-nugent.github.io/cv/Nugent_CV.pdf).
...
Related to my dissertation, I work frequently with the [SEARCH Collaboration](https://www.searchendaids.com/), evaluating impacts of various interventions to reduce infectious disease burden in Kenya and Uganda. Recent projects include:

 + Analysis of CRT to reduce rates of tuberculosis

 + Analysis of CRT to increase isoniazid preventive therapy (IPT) uptake among people living with HIV
 
 + Analysis of social network predictors of pre-exposure prophylaxis (PrEP) uptake
 
 + Analysis of effectiveness of intervention to reduce HIV incidence via universal HIV test-and-treat with PrEP
...
Peer-reviewed:
 ...
 + **Nugent, J**, Balzer, L. Evaluating shifts in mobility and COVID-19 case rates in U.S. counties: A demonstration of modified treatment policies for causal inference with continuous exposures. *(Under revision at the American Journal of Epidemiology, pre-print [here](http://arxiv.org/abs/2110.12529))*

 + Kakande E, Christian C, Balzer LB, Owaraganise A, **Nugent J**, DiIeso W, Rast D, Kabami J, Johnson J, Camlin CS, Shade SB, Geng E, Kwarisiima D, Kamya MR, Havlir DV, Chamie G. Cluster RCT of a mid-level manager intervention to promote IPT uptake in Uganda. *(Under review at the Lancet HIV)*
...
In progress: Methods
 ...
 + **Nugent, J**, Balzer, L. Two-stage TMLE for cluster randomized trials with few independent units and missingness. *(Dissertation chapter)*
